...
sed -i '' -e "s/$DYNATRACE_IOS_APP_ID/__DYNATRACE_IOS_APP_ID__/" $DYNATRACE_IOS_FILE 
...
sed -i '' -e "s/$DYNATRACE_ANDROID_APP_ID/__DYNATRACE_ANDROID_APP_ID__/" $DYNATRACE_ANDROID_FILE 
...
sed -i '' -e "s/$DYNATRACE_IOS_APP_ID/__DYNATRACE_IOS_APP_ID__/" $DYNATRACE_PLUGIN_FILE 
...
sed -i '' -e "s/$DYNATRACE_ANDROID_APP_ID/__DYNATRACE_ANDROID_APP_ID__/" $DYNATRACE_PLUGIN_FILE 
