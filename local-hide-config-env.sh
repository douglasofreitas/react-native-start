...
sed -i '' -e "s,$DYNATRACE_BEACON_URL,__DYNATRACE_BEACON_URL__,g" $DYNATRACE_IOS_FILE 
...
sed -i '' -e "s,$DYNATRACE_BEACON_URL,__DYNATRACE_BEACON_URL__,g" $DYNATRACE_ANDROID_FILE 
