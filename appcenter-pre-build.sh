...
sed -i '' -e "s/__DYNATRACE_IOS_APP_ID__/$DYNATRACE_IOS_APP_ID/" $DYNATRACE_PLUGIN_FILE 
...
sed -i '' -e "s/__DYNATRACE_ANDROID_APP_ID__/$DYNATRACE_ANDROID_APP_ID/" $DYNATRACE_PLUGIN_FILE 
