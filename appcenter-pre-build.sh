...
sed -i -e "s/__DYNATRACE_IOS_APP_ID__/$DYNATRACE_IOS_APP_ID/" $DYNATRACE_IOS_FILE 
sed -i -e "s/__DYNATRACE_IOS_ENVIRONMENT__/$DYNATRACE_IOS_ENVIRONMENT/" $DYNATRACE_IOS_FILE 
sed -i -e "s/__DYNATRACE_IOS_CLUSTER_URL__/$DYNATRACE_IOS_CLUSTER_URL/" $DYNATRACE_IOS_FILE 
...
sed -i -e "s/__DYNATRACE_ANDROID_APP_ID__/$DYNATRACE_ANDROID_APP_ID/" $DYNATRACE_ANDROID_FILE 
sed -i -e "s/__DYNATRACE_ANDROID_BEACON_URL__/$DYNATRACE_ANDROID_BEACON_URL/" $DYNATRACE_ANDROID_FILE 
