...
sed -i '' -e "s,__DYNATRACE_BEACON_URL__,$DYNATRACE_BEACON_URL,g" $DYNATRACE_IOS_FILE 
...
sed -i '' -e "s,__DYNATRACE_BEACON_URL__,$DYNATRACE_BEACON_URL,g" $DYNATRACE_ANDROID_FILE 
